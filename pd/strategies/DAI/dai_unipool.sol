...
contract StrategyUniswap_ETH_DAI_LP {
    ...
    address constant public output = address(0x368B3a58B5f49392e5C9E4C998cb0bB966752E51); // MIC
    address constant public weth = address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);
    address constant public usdt = address(0xdAC17F958D2ee523a2206206994597C13D831ec7); // USDT
    address constant public miner = address(0xcE0058827e6c89E625e524D2fE6E3EF3d9BB6A0c);  
    ...
    address[] public swap2WETH;
    address[] public swap2usdt;
    ...
    function doswap() internal {
        uint256 t = IERC20(output).balanceOf(address(this)); 
        
        // Mic -> USDT
        UniswapRouter(sushirouter).swapExactTokensForTokens(t, 0, swap2usdt, address(this), now.add(1800));
        t =  IERC20(usdt).balanceOf(address(this)); 
        // USDT -> WETH
        UniswapRouter(unirouter).swapExactTokensForTokens(t, 0, swap2WETH, address(this), now.add(1800));
        // WETH -> YFII 10%
