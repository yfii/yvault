...
contract iVault is ERC20, ERC20Detailed {
    ...
    uint public min = 9900; // Altcoin 9900, StableCoin 9500?
    ...
    constructor (address _token) public ERC20Detailed(
        ...
        token = IERC20(_token);
        governance = tx.origin; // msg.sender or tx.origin?
    ...
    function depositAll() external { //允許全部提出
        deposit(token.balanceOf(msg.sender));
    }
    
    function deposit(uint _amount) public { //提現
        uint _pool = balance();
